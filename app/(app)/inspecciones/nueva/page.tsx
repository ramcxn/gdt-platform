        ...
        <div className="glass-card rounded-xl border border-white/5 p-5 space-y-5">
          ...
          <div className="flex justify-between pt-2">
            ...
            <button onClick={handleSubmit} disabled={saving}
              className="flex items-center gap-2 px-6 py-2.5 rounded-xl text-white text-sm font-bold disabled:opacity-50 cursor-pointer shadow-sm transition-transform hover:scale-105 btn-accent">
